...
import { ProductItem } from '../../pages/marketplace/pages/product/productItem';

const OpenedUserProdutSaved = () => {
  // navigate
  ...
  return (
    ...
    >
      <Container ref={scrollRef} openproduct={openProduct ? 'true' : 'false'}>
        ...
        <ProductItem item={product} to="/feeds/user" scrollRef={scrollRef} />
      </Container>
    </div>
  );
};

export default OpenedUserProdutSaved;
